function drawAccTable(data, selector, labels, textLabels, type) {
  ...
  var partyCell = partyRow.selectAll('td')
    .data(function (row) {
      return labels.map(function (column) {
        ...
        return { column: column, value: row[column], party: row["party"] };
      });
    })
    .enter()
    .append('td')
    ...
    .html(function (d, i) {
      ...
      if (d.column === "party" || d.column === "id") {
        ...
        console.log(d)
        return d.value + "<img src='assets/img/logos/" + d.party + ".png' />";
        // return d.value + "<img src='https://via.placeholder.com/32' />";
      } else if (d.column === "votes%") {
